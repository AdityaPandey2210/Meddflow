...
function Story() {
    return (
        <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.7 }} className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, ease: "easeOut" }} className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                <motion.img initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.3 }} whileHover={{ scale: 1.05 }} className="object-cover object-center rounded" src={AboutImage2} alt="" />
            </motion.div>
...
function Mission() {
    return (
        <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.7 }} className="container mx-auto flex px-7 py-24 md:flex-row flex-col items-center">
            <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, ease: "easeOut" }} className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                <motion.h1 initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="sm:text-4xl text-3xl mb-4 font-bold text-gray-900">Our <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#159957] to-[#155799]">Mission</span></motion.h1>
                <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="mb-8 leading-relaxed">Our mission at Meddflow is to revolutionize healthcare through cutting-edge digital solutions that enhance efficiency, security, and patient care. We strive to empower healthcare providers with seamless technology that simplifies workflows and improves decision-making. By integrating AI, automation, and cloud-based solutions, we ensure secure and scalable healthcare management.</motion.p>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, ease: "easeOut" }} className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 h-96">
                <motion.img initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.3 }} whileHover={{ scale: 1.05 }} className="h-full object-cover object-center rounded-lg" src={AboutImage1} alt="" />
            </motion.div>
        </motion.section>
    )
}
...
function Team() {
    return (
        <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.7 }} className="container px-5 py-16 mx-auto">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col text-center w-full mb-10">
                <motion.h1 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.2 }} className="sm:text-4xl text-3xl font-bold mb-4 text-gray-900">Our <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#159957] to-[#155799]">Leadership</span></motion.h1>
            ...
            <div className="flex flex-wrap -m-4">
                {teamMembers.map((member, index) => <TeamTile key={index} image={member.image} name={member.name} title={member.title} bio={member.bio} facebook={member.facebook} insta={member.insta} linkedin={member.linkedin} delay={0.1 * index} />)}
            </div>
        </motion.section>
    )
}
...
function Values() {
    return (
        <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.7 }} className="relative w-full px-5 py-24 mx-auto">
            <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${AboutImage3})` }}></div>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.8, delay: 0.2 }} className="absolute inset-0 bg-gradient-to-r from-[#155799]/85 to-[#159957]/85"></motion.div>
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="relative z-10 flex flex-col text-center w-full mb-20">
                <motion.h1 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.5 }} className="sm:text-4xl text-3xl font-bold mb-4 text-white">Our Core Values</motion.h1>
...
function Clients() {
    return (
        <section className="py-24 overflow-hidden">
            <div className="w-screen items-center mx-auto relative">
                <div className="flex flex-col text-center w-full mb-10">
                    <h1 className="sm:text-4xl text-3xl font-bold mb-4 text-gray-900">Our <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#159957] to-[#155799]">Partners</span></h1>
                </div>
                <div className="mt-7 flex text-center text-gray-700 items-center justify-center" style={{ whiteSpace: 'nowrap' }}>
                    <div className="px-8">
                        <svg className="h-12 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 266 100">
                    ...
                    <div className="px-8">
                        <svg className="h-5 mt-1 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 278.7 36.3">
                    ...
                    <div className="px-8">
                        <svg className="h-8 mt-2 fill-current" viewBox="0 0 398 120" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="px-8">
                        <svg className="h-8 fill-current" viewBox="0 0 2270 546" xmlns="http://www.w3.org/2000/svg">
