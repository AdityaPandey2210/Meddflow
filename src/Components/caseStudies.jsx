    ...
    const OverviewTile = ({ image, title, description }) => {
        return (
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="px-2.5 py-2.5 lg:w-1/3 md:w-1/2 w-full">
                <motion.div whileHover={{ scale: 1.03 }} transition={{ duration: 0.3 }} className="h-full flex flex-col items-center border-gray-400 border rounded hover:text-white hover:bg-gradient-to-t from-[#159957] to-[#155799]">
                    ...
                    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.2 }} className="p-7 flex-grow text-start">
                        ...
                        <motion.button initial={{ opacity: 0, x: -10 }} whileInView={{ opacity: 1, x: 0 }} whileHover={{ x: 5 }} whileTap={{ scale: 0.95 }} transition={{ duration: 0.5, delay: 0.5 }} className='mt-3'>Read More <i className="bi bi-chevron-right text-sm"></i></motion.button>
                    </motion.div>
                </motion.div>
            </motion.div>
        )
    ...
    return (
        <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.7 }} className="container px-5 py-24 mx-auto">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="flex flex-col text-center w-full mb-20">
                <motion.h1 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.2 }} className="sm:text-4xl text-3xl font-bold mb-4 text-gray-900">Overview of<span className="bg-clip-text text-transparent bg-gradient-to-r from-[#159957] to-[#155799]"> Our Impact</span></motion.h1>
